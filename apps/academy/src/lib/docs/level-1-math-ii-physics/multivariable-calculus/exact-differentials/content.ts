...
<Equation label="Exact differential" tex="dF=M\,dx+N\,dy" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Exact Differentials" },
    { label: "Use the central relation", tex: "dF=M\\,dx+N\\,dy" },
    { label: "Interpret the result", tex: "Exact differential" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Exact Differentials.",
      answer: "The central relation is Exact differential: dF=M\\,dx+N\\,dy. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Exact Differentials appear in a physics calculation?",
      answer: "Exact Differentials is used when recognising differentials that come from a scalar potential function. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
