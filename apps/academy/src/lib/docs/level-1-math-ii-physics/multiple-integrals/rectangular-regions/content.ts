...
<Equation label="Rectangular iterated integral" tex="\int_a^b\int_c^d f(x,y)\,dy\,dx" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Rectangular Regions" },
    { label: "Use the central relation", tex: "\\int_a^b\\int_c^d f(x,y)\\,dy\\,dx" },
    { label: "Interpret the result", tex: "Rectangular iterated integral" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Rectangular Regions.",
      answer: "The central relation is Rectangular iterated integral: \\int_a^b\\int_c^d f(x,y)\\,dy\\,dx. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Rectangular Regions appear in a physics calculation?",
      answer: "Rectangular Regions is used when integrating over regions with constant rectangular bounds. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
