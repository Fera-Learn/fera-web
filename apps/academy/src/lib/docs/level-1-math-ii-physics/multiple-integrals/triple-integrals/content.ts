...
<Equation label="Triple integral" tex="\iiint_V f(x,y,z)\,dV" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Triple Integrals" },
    { label: "Use the central relation", tex: "\\iiint_V f(x,y,z)\\,dV" },
    { label: "Interpret the result", tex: "Triple integral" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Triple Integrals.",
      answer: "The central relation is Triple integral: \\iiint_V f(x,y,z)\\,dV. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Triple Integrals appear in a physics calculation?",
      answer: "Triple Integrals is used when accumulating a scalar field over a volume. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
