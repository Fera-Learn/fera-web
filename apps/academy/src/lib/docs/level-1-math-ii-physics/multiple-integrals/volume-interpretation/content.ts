...
<Equation label="Volume under surface" tex="V=\iint_R f(x,y)\,dA" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Volume Interpretation" },
    { label: "Use the central relation", tex: "V=\\iint_R f(x,y)\\,dA" },
    { label: "Interpret the result", tex: "Volume under surface" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Volume Interpretation.",
      answer: "The central relation is Volume under surface: V=\\iint_R f(x,y)\\,dA. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Volume Interpretation appear in a physics calculation?",
      answer: "Volume Interpretation is used when interpreting a double integral as signed volume under a surface. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
