...
<Equation label="Polar area element" tex="dA=r\,dr\,d\theta" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Polar Integration" },
    { label: "Use the central relation", tex: "dA=r\\,dr\\,d\\theta" },
    { label: "Interpret the result", tex: "Polar area element" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Polar Integration.",
      answer: "The central relation is Polar area element: dA=r\\,dr\\,d\\theta. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Polar Integration appear in a physics calculation?",
      answer: "Polar Integration is used when using polar coordinates and the area factor r for circular regions. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
