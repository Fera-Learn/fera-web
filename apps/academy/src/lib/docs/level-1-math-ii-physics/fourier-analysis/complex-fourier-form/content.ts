...
<Equation label="Complex Fourier series" tex="f(x)\sim\sum_{n=-\infty}^{\infty}c_ne^{inx}" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Complex Fourier Form" },
    { label: "Use the central relation", tex: "f(x)\\sim\\sum_{n=-\\infty}^{\\infty}c_ne^{inx}" },
    { label: "Interpret the result", tex: "Complex Fourier series" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Complex Fourier Form.",
      answer: "The central relation is Complex Fourier series: f(x)\\sim\\sum_{n=-\\infty}^{\\infty}c_ne^{inx}. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Complex Fourier Form appear in a physics calculation?",
      answer: "Complex Fourier Form is used when using complex exponential modes indexed by all integers. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
