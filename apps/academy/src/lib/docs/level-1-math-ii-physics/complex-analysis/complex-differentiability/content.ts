...
<Equation label="Complex derivative" tex="f'(z_0)=\lim_{h\to0}\frac{f(z_0+h)-f(z_0)}{h}" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Complex Differentiability" },
    { label: "Use the central relation", tex: "f'(z_0)=\\lim_{h\\to0}\\frac{f(z_0+h)-f(z_0)}{h}" },
    { label: "Interpret the result", tex: "Complex derivative" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Complex Differentiability.",
      answer: "The central relation is Complex derivative: f'(z_0)=\\lim_{h\\to0}\\frac{f(z_0+h)-f(z_0)}{h}. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Complex Differentiability appear in a physics calculation?",
      answer: "Complex Differentiability is used when requiring the complex derivative limit to be independent of approach direction. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
