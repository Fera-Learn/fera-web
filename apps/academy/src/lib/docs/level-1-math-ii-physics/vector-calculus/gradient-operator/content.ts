...
<Equation label="Nabla operator" tex="\nabla=\mathbf i\frac{\partial}{\partial x}+\mathbf j\frac{\partial}{\partial y}+\mathbf k\frac{\partial}{\partial z}" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Gradient Operator" },
    { label: "Use the central relation", tex: "\\nabla=\\mathbf i\\frac{\\partial}{\\partial x}+\\mathbf j\\frac{\\partial}{\\partial y}+\\mathbf k\\frac{\\partial}{\\partial z}" },
    { label: "Interpret the result", tex: "Nabla operator" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Gradient Operator.",
      answer: "The central relation is Nabla operator: \\nabla=\\mathbf i\\frac{\\partial}{\\partial x}+\\mathbf j\\frac{\\partial}{\\partial y}+\\mathbf k\\frac{\\partial}{\\partial z}. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Gradient Operator appear in a physics calculation?",
      answer: "Gradient Operator is used when using nabla to build gradient, divergence, and curl operations. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
