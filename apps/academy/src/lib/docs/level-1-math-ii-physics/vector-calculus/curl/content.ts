...
<Equation label="Curl" tex="\nabla\times\mathbf F" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Curl" },
    { label: "Use the central relation", tex: "\\nabla\\times\\mathbf F" },
    { label: "Interpret the result", tex: "Curl" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Curl.",
      answer: "The central relation is Curl: \\nabla\\times\\mathbf F. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Curl appear in a physics calculation?",
      answer: "Curl is used when measuring local rotation or circulation density of a vector field. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
