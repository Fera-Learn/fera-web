...
<Equation label="Boundary values" tex="y(a)=\alpha,\quad y(b)=\beta" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Boundary Conditions" },
    { label: "Use the central relation", tex: "y(a)=\\alpha,\\quad y(b)=\\beta" },
    { label: "Interpret the result", tex: "Boundary values" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Boundary Conditions.",
      answer: "The central relation is Boundary values: y(a)=\\alpha,\\quad y(b)=\\beta. Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Boundary Conditions appear in a physics calculation?",
      answer: "Boundary Conditions is used when using endpoint or boundary data to determine allowed solutions. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
