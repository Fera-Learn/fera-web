...
<Equation label="Linear second-order form" tex="a(x)y''+b(x)y'+c(x)y=r(x)" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Linear Second-Order Equations" },
    { label: "Use the central relation", tex: "a(x)y''+b(x)y'+c(x)y=r(x)" },
    { label: "Interpret the result", tex: "Linear second-order form" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Linear Second-Order Equations.",
      answer: "The central relation is Linear second-order form: a(x)y''+b(x)y'+c(x)y=r(x). Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Linear Second-Order Equations appear in a physics calculation?",
      answer: "Linear Second-Order Equations is used when using superposition and particular solutions for second-order linear models. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
