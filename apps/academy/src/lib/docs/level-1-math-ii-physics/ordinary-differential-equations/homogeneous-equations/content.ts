...
<Equation label="Homogeneous first-order equation" tex="\frac{dy}{dx}=F\!\left(\frac{y}{x}\right)" />

<PhysicsDerivation
  items={[
    { label: "Name the task", tex: "Homogeneous Equations" },
    { label: "Use the central relation", tex: "\\frac{dy}{dx}=F\\!\\left(\\frac{y}{x}\\right)" },
    { label: "Interpret the result", tex: "Homogeneous first-order equation" },
  ]}
/>
...
<PhysicsExamples
  items={[
    {
      title: "Example 1",
      question: "Identify the central relation for Homogeneous Equations.",
      answer: "The central relation is Homogeneous first-order equation: \\frac{dy}{dx}=F\\!\\left(\\frac{y}{x}\\right). Use it after naming the variables and checking the assumptions.",
    },
    {
      title: "Example 2",
      question: "How does Homogeneous Equations appear in a physics calculation?",
      answer: "Homogeneous Equations is used when solving first-order equations whose slope depends on the ratio y/x. In a physics model, first attach units and a domain, then apply the relation to the field, signal, or motion being studied.",
    },
  ]}
/>
