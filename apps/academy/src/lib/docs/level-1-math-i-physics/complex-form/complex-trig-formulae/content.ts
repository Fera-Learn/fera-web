...
Connections between complex exponentials and trig functions:
...
<Equation label="Identity 1" tex="\cos^2\theta + \sin^2\theta = 1" />

<Equation label="Identity 2" tex="\cosh^2 x - \sinh^2 x = 1" />`;
