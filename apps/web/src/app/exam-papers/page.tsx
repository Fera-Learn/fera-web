...
export default async function ExamPapersPage() {
  ...
  const physics = stats.courses.find((course) => course.slug === "level-1-physics");
  ...
  return (
    <>
      ...
      <MarketingShell>
        ...
        >
          Move beyond isolated questions with full paper sets, marks, timing, and topic coverage designed to test readiness across a course.
        </PageHero>
        ...
        <Section className="pt-0">
          <div className="grid items-start gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            >
              Full paper sets connect marks, timing, and topic coverage so exam practice tests readiness instead of isolated recall.
            </SectionHeading>
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-start">
                <div>
                  ...
                  <Button asChild className="mt-8">
                    <Link href={productLinks.examPapers}>Open Level 1 Physics papers</Link>
                  </Button>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                  <div className="border border-border bg-background p-5">
                    ...
                    <span className="text-sm text-muted-foreground">exam papers</span>
                  </div>
                  <div className="border border-border bg-background p-5">
                    <strong className="block text-3xl tracking-[-0.05em]">
                      {physics.questionCount.toLocaleString()}
                    </strong>
                    <span className="text-sm text-muted-foreground">supporting questions</span>
                  </div>
                </div>
              </div>
            </div>
